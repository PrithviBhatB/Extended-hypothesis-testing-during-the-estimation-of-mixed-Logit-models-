...
bench_mark =  code_name + 'output_' + current_date + '.txt'
...
ps_intercept = None  #(None or True or False)

#prespecification on transformations
ps_bctrans = False #(None or True or False)
...
ps_cor = None #(None or True or False)
                ...
                while any([v for v in sig if v > 0.05]):
                    ...
                    if nsig_altspec_vars:
                        ...
                        #rem_asvars = remove_redundant_asvars(asvars_round2,trans_asvars,seed)
                            ...
                            #rem_asvars = remove_redundant_asvars(asvars_round2,trans_asvars,seed)
                            rem_asvars = asvars_round2 #checking if remove_redundant_asvars is needed or not
                        else:
                    ...
                    if ns_cors:
                        ...
                        nscorvars = [k for k,v in most_nscorvars.items() if v >= int(len(cor_vars)*0.75)]
