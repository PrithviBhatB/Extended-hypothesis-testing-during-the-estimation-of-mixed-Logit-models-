...
code_name = 'Berlin_July_' #Name for the search 
...
model.fit(X=df[base_varnames].values, y=choice_var, varnames=base_varnames, alts=alt_var,
...
itr_max = 150 #150 maximum number of iterations
v = 0.75 #proportion of iterations to improvise harmony. The rest will be for local search
threshold = 30 #threshold to compare new solution with worst solution in memory
