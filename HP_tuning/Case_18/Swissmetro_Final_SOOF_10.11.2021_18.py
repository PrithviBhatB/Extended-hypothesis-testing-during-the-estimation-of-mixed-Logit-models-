...
HMCR_min = 0.8 #0.9 #minimum harmony memory consideration rate
HMCR_max = 0.8 #0.99 #maximum harmony memory consideration rate
PAR_min = 0.05 # 0.8 #min pitch adjustment
PAR_max = 0.95 #0.85 #maximum pitch adjustment
