...
HMS = 80 #20 #harmony memory size
HMCR_min = 0.5 #0.9 #minimum harmony memory consideration rate
HMCR_max = 0.97 #0.99 #maximum harmony memory consideration rate
PAR_min = 0.0 # 0.8 #min pitch adjustment
PAR_max = 0.85 #0.85 #maximum pitch adjustment
itr_max = 1000 #300 #150 maximum number of iterations
