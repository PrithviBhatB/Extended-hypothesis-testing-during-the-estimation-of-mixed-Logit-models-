...
HMCR_min = 0.7 #0.9 #minimum harmony memory consideration rate
HMCR_max = 0.85 #0.99 #maximum harmony memory consideration rate
PAR_min = 0 # 0.8 #min pitch adjustment
