...
HMS = 10 #20 #harmony memory size
HMCR_min = 0.9 #0.9 #minimum harmony memory consideration rate
HMCR_max = 0.97 #0.99 #maximum harmony memory consideration rate
PAR_min = 0.1 # 0.8 #min pitch adjustment
PAR_max = 0.95 #0.85 #maximum pitch adjustment
itr_max = 600 #300 #150 maximum number of iterations
